...
public class TicketController {
    ...
    public @ResponseBody ResponseEntity<Object> getEvent(@RequestParam Integer ticketId) {
    ...
    public @ResponseBody ResponseEntity<Object> admitTicket(@RequestParam Integer ticketId) {
